...
from pdf_processor.models import DocumentChunk

class Command(BaseCommand):
    help = '分析数据库中的文档分块情况'

    def handle(self, *args, **options):
        self.stdout.write("🔍 分析数据库中的文档分块情况")
        ...
        try:
            ...
            if avg_chunk_size < 700 * PDFUtils._avg_chars_per_token * 0.8:
            ...
            if max_chunk_size < GlobalConfig.CHUNK_SIZE * PDFUtils._avg_chars_per_token * 0.8:
                self.stdout.write(self.style.WARNING("  ⚠️ 最大分块大小小于配置对应值（字符），可能存在截断问题"))
